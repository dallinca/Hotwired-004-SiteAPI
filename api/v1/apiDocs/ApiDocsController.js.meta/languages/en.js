...
module.exports = {
    [NAMES.ERROR_Example]: 'Example error message',
    
    [NAMES.SUCCESS_Example]: 'Example success message',
    ...
    [NAMES.ERROR_User_Permissions]: 'The Token Owner does not have sufficient permissions for this action. Please contact your system administrator.',
